...
def run_sim(opt,device):
    ...
    for sim_i in sim_bar:
        ...
        for trial_i in range(opt.init_trial,opt.init_trial+opt.n_trial):
            ...
            Distributed_Model = MNIST_Sim_CoreSets(params,"Distributed",device,copy.deepcopy(Unc_Model.model))
            Oracle_Model = MNIST_Sim_CoreSets(params,"Oracle",device,copy.deepcopy(Unc_Model.model))
            Interactive_Model = MNIST_Sim_CoreSets(params,"Interactive",device,copy.deepcopy(Unc_Model.model))
