...
if __name__ == "__main__":
    try:
        ...
        parser.add_argument("--img-loc", type=str,default="/store/datasets/AdversarialWeather/Recordings_resized")
        ...
        parser.add_argument("--n-unique-device", type=hparam, default=10)
        parser.add_argument("--n-same-device", type=hparam, default=3)
        parser.add_argument("--n-sim", type=hparam, default=2)
        parser.add_argument("--n-rounds", type=hparam, default=5)
        parser.add_argument("--n-epoch", type=hparam, default=200)
        parser.add_argument("--b-size", type=hparam, default=64)
        ...
        parser.add_argument("--test-b-size", type=hparam, default=128)
        parser.add_argument("--lr", type=hparam, default=0.1)
        parser.add_argument("--n-size", type=hparam, default=30)
        parser.add_argument("--n-obs", type=hparam, default=1000)
        parser.add_argument("--n-cache", type=hparam, default=2)
        parser.add_argument("--run-loc", type=str, default="./old-runs/AdversarialWeather")
        parser.add_argument("--plot-loc", type=str, default="./plots/AdversarialWeather")
        parser.add_argument("--n-trial",type=hparam, default=2)
