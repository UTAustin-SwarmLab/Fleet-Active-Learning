...
from ultralytics_yolo.ultralytics.yolo.data.build import load_inference_source
from ultralytics_yolo.ultralytics.yolo.utils import LINUX, ONLINE, ROOT, SETTINGS
...
def test_amp():
    if torch.cuda.is_available():
        from ultralytics_yolo.ultralytics.yolo.engine.trainer import check_amp
