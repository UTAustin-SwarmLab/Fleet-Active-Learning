...
from ultralytics_yolo.ultralytics.yolo.utils import LINUX, LOGGER, ROOT, yaml_load
from ultralytics_yolo.ultralytics.yolo.utils.checks import check_requirements, check_suffix, check_version, check_yaml
from ultralytics_yolo.ultralytics.yolo.utils.downloads import attempt_download_asset, is_url
from ultralytics_yolo.ultralytics.yolo.utils.ops import xywh2xyxy
...
class AutoBackend(nn.Module):
    ...
    def __init__(self,
        ...
        if nn_module:
            ...
            from ultralytics_yolo.ultralytics.nn.tasks import attempt_load_weights
            ...
            from ultralytics_yolo.ultralytics.yolo.engine.exporter import gd_outputs
            ...
            from ultralytics_yolo.ultralytics.yolo.engine.exporter import export_formats
